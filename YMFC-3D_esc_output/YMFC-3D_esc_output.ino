...
//Serial.begin(9600);
  ...
  while(receiver_input_channel_3 < 990 || receiver_input_channel_3 > 1200 || receiver_input_channel_4 < 1400){
...
void print_signals(){
  ...
  if(receiver_input_channel_3<1480)Serial.print("<<<");//Should be 1480-1520
  else if(receiver_input_channel_3>1520)Serial.print(">>>");
  else Serial.print("-*-");
  Serial.print(receiver_input_channel_3);

  Serial.print(" Yaw");
  if(receiver_input_channel_4<1430)Serial.print(">>>"); //Should be 1480-1520
  else if(receiver_input_channel_4>1560)Serial.print("<<<");
  else Serial.print("-*-");
